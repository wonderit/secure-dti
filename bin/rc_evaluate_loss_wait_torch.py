...
parser.add_argument("-p", "--comet_project", help="Set project name", type=str, default='secure-rc-c')
...
parser.add_argument("-model", "--model_type", help="model name(small)", type=str, default='small')
...
def r_squared_mse(y_true, y_pred, mse):
    if args.spearman:
        print('calculate spearman r')
