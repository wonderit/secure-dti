...
:
EvalIterator(aEval
.m_argImpl, outer + (XprIsRowMajor ? aEval.m_block.
...
m_end(XprIsRowMajor ? aEval.m_block.startCol() + aEval.m_block.blockCols() : aEval.m_block.startRow() +
