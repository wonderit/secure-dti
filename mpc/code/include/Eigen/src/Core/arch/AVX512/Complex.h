...
//---------- float ----------
    ...
    padd<Packet8cf>(const Packet8cf &a, const Packet8cf &b) { return Packet8cf(_mm512_add_ps(a.v, b.v)); }

    template<> EIGEN_STRONG_INLINE Packet8cf

    psub<Packet8cf>(const Packet8cf &a, const Packet8cf &b) { return Packet8cf(_mm512_sub_ps(a.v, b.v)); }
    ...
    pandnot<Packet8cf>(const Packet8cf &a, const Packet8cf &b) { return Packet8cf(pandnot(a.v, b.v)); }
...
struct conj_helper<Packet8cf, Packet8cf, false, true> {
    ...
    pmadd(const Packet8cf &x, const Packet8cf &y, const Packet8cf &c) const { return padd(pmul(x, y), c); }

    EIGEN_STRONG_INLINE Packet8cf

    pmul(const Packet8cf &a, const Packet8cf &b) const {
...
padd<Packet4cd>(const Packet4cd &a, const Packet4cd &b) { return Packet4cd(_mm512_add_pd(a.v, b.v)); }

template<> EIGEN_STRONG_INLINE Packet4cd

psub<Packet4cd>(const Packet4cd &a, const Packet4cd &b) { return Packet4cd(_mm512_sub_pd(a.v, b.v)); }
...
struct conj_helper<Packet4cd, Packet4cd, false, true> {
    ...
    pmadd(const Packet4cd &x, const Packet4cd &y, const Packet4cd &c) const { return padd(pmul(x, y), c); }
