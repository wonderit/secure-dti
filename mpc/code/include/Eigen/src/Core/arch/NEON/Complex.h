...
//---------- float ----------
    ...
    pcast<float, Packet1cf>(const float &a) { return Packet1cf(vset_lane_f32(a, vdup_n_f32(0.f), 0)); }
    ...
    padd<Packet1cf>(const Packet1cf &a, const Packet1cf &b) { return Packet1cf(padd < Packet2f > (a.v, b.v)); }
    ...
    psub<Packet1cf>(const Packet1cf &a, const Packet1cf &b) { return Packet1cf(psub < Packet2f > (a.v, b.v)); }
...
preverse(const Packet2cf &a) { return Packet2cf(vcombine_f32(vget_high_f32(a.v), vget_low_f32(a.v))); }
...
struct conj_helper<Packet1cf, Packet1cf, false, true> {
    ...
    pmadd(const Packet1cf &x, const Packet1cf &y, const Packet1cf &c) const { return padd(pmul(x, y), c); }

    EIGEN_STRONG_INLINE Packet1cf

    pmul(const Packet1cf &a, const Packet1cf &b) const { return internal::pmul(a, pconj(b)); }
};
...
struct conj_helper<Packet1cf, Packet1cf, true, false> {
    ...
    pmul(const Packet1cf &a, const Packet1cf &b) const { return internal::pmul(pconj(a), b); }
};
...
struct conj_helper<Packet1cf, Packet1cf, true, true> {
    ...
    pmul(const Packet1cf &a, const Packet1cf &b) const { return pconj(internal::pmul(a, b)); }
};
...
struct conj_helper<Packet2cf, Packet2cf, false, true> {
    ...
    pmul(const Packet2cf &a, const Packet2cf &b) const { return internal::pmul(a, pconj(b)); }
};
...
struct conj_helper<Packet2cf, Packet2cf, true, false> {
    ...
    pmul(const Packet2cf &a, const Packet2cf &b) const { return internal::pmul(pconj(a), b); }
};
...
struct conj_helper<Packet2cf, Packet2cf, true, true> {
    ...
    pmul(const Packet2cf &a, const Packet2cf &b) const { return pconj(internal::pmul(a, b)); }
};
