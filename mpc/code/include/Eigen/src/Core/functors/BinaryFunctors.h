...
/** \internal
  ...
  */
        ...
        scalar_sum_op<bool, bool>::operator()(const bool &a, const bool &b) const { return a || b; }
...
/** \internal
  ...
  */
        ...
        template<>
        EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool
        scalar_product_op<bool, bool>::operator()(const bool &a, const bool &b) const { return a && b; }
  ...
  */
        ...
        struct scalar_cmp_with_cast_op<LhsScalar, RhsScalar, cmp_EQ> : binary_op_base<LhsScalar, RhsScalar> {
            ...
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet packetOp(const Packet &a, const Packet &b) const {
              return internal::pselect(internal::pcmp_eq(a, b), internal::pset1<Packet>(static_cast<result_type>(1)),
                                       internal::pzero(a));
            }
        };
        ...
        struct scalar_cmp_with_cast_op<LhsScalar, RhsScalar, cmp_LT> : binary_op_base<LhsScalar, RhsScalar> {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet packetOp(const Packet &a, const Packet &b) const {
              return internal::pselect(internal::pcmp_lt(a, b), internal::pset1<Packet>(static_cast<result_type>(1)),
                                       internal::pzero(a));
            }
        };
        ...
        struct scalar_cmp_with_cast_op<LhsScalar, RhsScalar, cmp_LE> : binary_op_base<LhsScalar, RhsScalar> {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet packetOp(const Packet &a, const Packet &b) const {
              return internal::pselect(internal::pcmp_le(a, b), internal::pset1<Packet>(static_cast<result_type>(1)),
                                       internal::pzero(a));
            }
        };
        ...
        struct scalar_cmp_with_cast_op<LhsScalar, RhsScalar, cmp_UNORD> : binary_op_base<LhsScalar, RhsScalar> {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet packetOp(const Packet &a, const Packet &b) const {
              return internal::pselect(por(internal::pcmp_le(a, b), internal::pcmp_le(b, a)), internal::pzero(a),
                                       internal::pset1<Packet>(static_cast<result_type>(1)));
            }
        };
...
/** \internal
  ...
  */
        struct scalar_boolean_and_op {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet
            packetOp(const Packet &a, const Packet &b) const { return internal::pand(a, b); }
        };
...
/** \internal
  ...
  */
        struct scalar_boolean_or_op {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet
            packetOp(const Packet &a, const Packet &b) const { return internal::por(a, b); }
        };
 ...
 */
        struct scalar_boolean_xor_op {
            ...
            template<typename Packet>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Packet
            packetOp(const Packet &a, const Packet &b) const { return internal::pxor(a, b); }
        };
...
#endif
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const result_type
            operator()(const LhsScalar &a, const RhsScalar &b) const { return numext::absdiff(a, b); }
