...
/** \class Matrix
  ...
  *
  * \li \c MatrixXm is a 2x2 square matrix of doubles (\c Matrix<double, 2, 2>)
...
public:
    ...
    /** \brief Constructs a Matrix and initializes it from the coefficients given as initializer-lists grouped by row. \cpp11
      ...
      */
    EIGEN_DEVICE_FUNC
    explicit EIGEN_STRONG_INLINE Matrix(const std::initializer_list<std::initializer_list<Scalar>> &list) : Base(
            list) {}
