    ...
    namespace internal {
        ...
        struct quat_conj<Architecture::SSE, Derived, float> {
            ...
            static inline Quaternion<float> run(const QuaternionBase <Derived> &q) {
              ...
              Quaternion<float> res;
              const Packet4f mask = _mm_setr_ps(-0.f, -0.f, -0.f, 0.f);
              pstoret<float, Packet4f, ResAlignment>(&res.x(), pxor(mask,
                                                                    qe.template packet<traits<Derived>::Alignment, Packet4f>(
                                                                            0)));
              return res;
            }
        };
        ...
        struct quat_conj<Architecture::SSE, Derived, double> {
            ...
            static inline Quaternion<double> run(const QuaternionBase <Derived> &q) {
              ...
              pstoret<double, Packet2d, ResAlignment>(&res.x(), pxor(mask0,
                                                                     qe.template packet<traits<Derived>::Alignment, Packet2d>(
                                                                             0)));
              pstoret<double, Packet2d, ResAlignment>(&res.z(), pxor(mask2,
                                                                     qe.template packet<traits<Derived>::Alignment, Packet2d>(
                                                                             2)));
              return res;
            }
